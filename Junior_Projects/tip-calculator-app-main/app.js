...
function calculateTotoalPerPerson() { }

// Event handlers
BillInput.addEventListener("keyup", () => {
  calculateTipPerPerson(parseInt(BillInput.value, 10), parseInt(NumberOfPeopleInput.value, 10), parseInt(CustomTipInput.value, 10))
});
